...
export const reposTool = createTool({
  ...
  inputSchema: z.object({
    owner: z.string().describe("Github organization owner/user id"),
  ...
  outputSchema: z.object({
    ...
    languages: z.string().describe("Github repository url"),
    issue: z.number().describe("Githun total numver of issues"),
